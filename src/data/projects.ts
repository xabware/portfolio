...
export const projects: Project[] = [
  {
    ...
    details: {
      ...
      en: {
        ...
        techDetails: 'The frontend is built with React 19 and TypeScript for type-safety. Vite provides ultra-fast bundling with instant HMR. Styles use modern CSS with CSS variables for dynamic theming. The chatbot uses WebLLM with Llama/Qwen models running on WebGPU. Global state is managed with React Context for themes and languages. The component structure follows the composition pattern with memo for render optimization.',
